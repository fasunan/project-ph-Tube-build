...
const showContent = async (categoryId) => {
  ...
  data.data.forEach((content) => {
    ...
    div.innerHTML = `
        ...
        <div class="card  w-72  max-h-72 bg-base-100 shadow-xl">
            <figure><img class="" src=${content.thumbnail} /></figure>
          <div class="text-end -mt-6"><span class=" bg-stone-800 rounded-md w-20 bg-auto text-white">${
            ...
            <div class="card-body">
              ...
              <div class="avatar">
                ...
                <svg width="20" height="20" -ml-1  viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    // verified tick
    const verifiedTik = content.authors[0].verified;
    if (verifiedTik) {
    }
...
// no content filed for drawing button

const noContentField = async (noContent) => {
  const response = await fetch(
...
//<div class="badge badge-secondary">"${content.authors[0].verified}"</div>
